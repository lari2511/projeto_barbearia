...
export default function AprovacaoAgendamento({
    ...
    const handleAprovar = async () => {
        try {
            ...
            alert('Nao foi possivel aprovar o agendamento. Tente novamente.');
        }
    };
    ...
    const handleRejeitar = async () => {
        ...
        try {
            ...
            alert('Nao foi possivel rejeitar o agendamento. Tente novamente.');
        }
    };
    ...
    const carregarHorarios = async () => {
        ...
        try {
            ...
            alert('Nao foi possivel carregar horarios alternativos. Tente novamente.');
        } finally {
